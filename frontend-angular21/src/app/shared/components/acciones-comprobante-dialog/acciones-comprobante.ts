...
@Component({
            ...
            <div class="acd-fila">
              ...
              >
                <span class="acd-btn__ico acd-ico--wsp">
                  <i
                    [class]="cargando() === 'wsp' ? 'pi pi-spin pi-spinner' : 'pi pi-whatsapp'"
                  ></i>
                </span>
              ...
              >
                <span class="acd-btn__ico acd-ico--email">
                  <i
                    [class]="cargando() === 'email' ? 'pi pi-spin pi-spinner' : 'pi pi-envelope'"
                  ></i>
                </span>
        ...
        <div class="acd-fila">
          ...
          >
            <span class="acd-btn__ico acd-ico--imprimir">
              <i
                [class]="cargando() === 'pdf-imprimir' ? 'pi pi-spin pi-spinner' : 'pi pi-print'"
              ></i>
            </span>
          ...
          >
            <span class="acd-btn__ico acd-ico--pdf">
              <i
                [class]="
                  cargando() === 'pdf-descargar' ? 'pi pi-spin pi-spinner' : 'pi pi-download'
                "
              ></i>
            </span>
          ...
          <div class="acd-fila">
            ...
            >
              <span class="acd-btn__ico acd-ico--imprimir">
                <i
                  [class]="
                    cargando() === 'nota-venta-imprimir' ? 'pi pi-spin pi-spinner' : 'pi pi-print'
                  "
                ></i>
              </span>
        ...
        <div class="acd-fila">
          ...
          >
            <span class="acd-btn__ico acd-ico--imprimir">
              <i
                [class]="
                  cargando() === 'voucher-imprimir' ? 'pi pi-spin pi-spinner' : 'pi pi-print'
                "
              ></i>
            </span>
          ...
          >
            <span class="acd-btn__ico acd-ico--voucher">
              <i
                [class]="
                  cargando() === 'voucher-descargar' ? 'pi pi-spin pi-spinner' : 'pi pi-download'
                "
              ></i>
            </span>
  ...
  styles: [
    `
      ...
      :host ::ng-deep .acd-dialog .p-dialog-content {
        padding: 0;
      }
      ...
      .acd-btn:hover:not(:disabled) .acd-btn__ico {
        transform: scale(1.1);
      }
      ...
      .acd-btn--wsp:hover:not(:disabled) {
        border-color: rgba(37, 211, 102, 0.3);
      }
      .acd-btn--email:hover:not(:disabled) {
        border-color: rgba(96, 165, 250, 0.3);
      }
      .acd-btn--pdf:hover:not(:disabled) {
        border-color: rgba(248, 113, 113, 0.3);
      }
      .acd-btn--voucher:hover:not(:disabled) {
