...
@Component({
  ...
  templateUrl: './historial-ventas-general.html',
  styleUrls: ['./historial-ventas-general.css'],
})
export class HistorialVentasGeneral implements OnInit, OnDestroy {
  tituloKicker = 'ADMIN - HISTORIAL DE VENTAS';
