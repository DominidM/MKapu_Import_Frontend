...
@Component({
  ...
  templateUrl: './generar-venta-admin.html',
  styleUrls: ['./generar-venta-admin.css'],
})
export class GenerarVentaAdmin implements OnInit, OnDestroy {
  tituloKicker = 'ADMIN - GENERAR VENTAS';
