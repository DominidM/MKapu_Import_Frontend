...
export class DispatchService {
  ...
  loadDispatches(role = 'Administrador', params?: LoadDispatchParams): Observable<DispatchPageResult> {
  ...
  cancelarDespacho(id: number | null, payload: CancelarDespachoRequest = {}, role = 'Administrador'): Observable<Dispatch> {
    return this.http
