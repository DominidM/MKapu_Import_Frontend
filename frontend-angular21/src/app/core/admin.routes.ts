// ══════════════════════════════════════════════════════════════════════════════
// RUTAS UNIFICADAS — Administración + Ventas
// Usar como ADMIN_ROUTES en admin.routes.ts
// Las rutas de ventas que apuntaban a componentes de administración
// ya están cubiertas directamente aquí.
// ══════════════════════════════════════════════════════════════════════════════

import { Routes } from '@angular/router';
import { pendingChangesGuard } from './guards/pending-changes.guard';
import { CashboxAdminGuard, CashboxGuard } from './guards/cashbox.guard';
...
export const ADMIN_ROUTES: Routes = [
  ...
  // ── Empresa ───────────────────────────────────────────────────────────────
  {
    ...
    loadComponent: () => import('./pages/empresa/empresa-configuracion').then(m => m.EmpresaConfiguracion),
  ...
  // ── Usuarios / Empleados ──────────────────────────────────────────────────
  {
    ...
    loadComponent: () => import('./pages/usuarios/pages/empleado-seguimiento/seguimiento-empleado').then(m => m.SeguimientoEmpleado),
    canActivate: [roleGuard],
    data: { permiso: 'ADMINISTRACION' },
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/dashboard-almacen/dashboard-almacen').then(m => m.DashboardAlmacen),
    canActivate: [roleGuard],
  ...
  // ── Nota de Crédito ───────────────────────────────────────────────────────
  {
    path: 'nota-credito',
    children: [
      { path: '', loadComponent: () => import('./pages/nota-credito/nota-credito').then(m => m.NotasCreditoComponent) },
  ...
  { path: 'agregar-cotizaciones', redirectTo: 'cotizaciones-venta/agregar-cotizaciones', pathMatch: 'full' },
  { path: 'ver-detalle-cotizacion/:id', redirectTo: 'cotizaciones-venta/ver-detalle-cotizacion/:id', pathMatch: 'full' },
  { path: 'agregar-cotizaciones', redirectTo: 'cotizaciones-venta/agregar-cotizaciones', pathMatch: 'full' },
  ...
  // ── Reclamos y Garantía ───────────────────────────────────────────────────
  {
    ...
    children: [
      { path: '', loadComponent: () => import('./pages/reclamos-garantia/reclamos-listado/reclamos-listado').then(m => m.ReclamosListado) },
      { path: 'crear', loadComponent: () => import('./pages/reclamos-garantia/reclamos-crear/reclamos-crear').then(m => m.ReclamosCrear) },
      { path: 'editar/:id', loadComponent: () => import('./pages/reclamos-garantia/reclamos-editar/reclamos-editar').then(m => m.ReclamosEditar) },
      { path: 'detalle/:id', loadComponent: () => import('./pages/reclamos-garantia/reclamos-detalles/reclamos-detalles').then(m => m.ReclamosDetalles) },
    ],
  },
  ...
  // ── Despacho ──────────────────────────────────────────────────────────────
  {
    ...
    children: [
      { path: '', loadComponent: () => import('./pages/despacho-productos/pages/listado-despacho/listado-despacho').then(m => m.ListadoDespacho) },
      { path: 'detalle-despacho/:id', loadComponent: () => import('./pages/despacho-productos/pages/detalles-despacho/detalles-despacho').then(m => m.DetallesDespacho) },
      { path: 'agregar-despacho', loadComponent: () => import('./pages/despacho-productos/pages/agregar-despacho/agregar-despacho').then(m => m.AgregarDespacho) },
      { path: 'confirmar-despacho', loadComponent: () => import('./pages/despacho-productos/pages/confirmar-despacho/confirmar-despacho').then(m => m.ConfirmarDespacho) },
      { path: 'editar-despacho/:id', loadComponent: () => import('./pages/despacho-productos/pages/editar-despacho/editar-despacho').then(m => m.EditarDespacho) },
    ],
  },
  ...
  // ── Conteo de Inventario ──────────────────────────────────────────────────
  {
    ...
    children: [
      { path: '', loadComponent: () => import('./pages/conteo-inventario/conteoinventario').then(m => m.ConteoInventarios) },
      { path: 'crear', loadComponent: () => import('./pages/conteo-crear/conteocrear').then(m => m.ConteoCrear) },
      { path: 'detalle/:id', loadComponent: () => import('./pages/conteo-detalle/conteodetalle').then(m => m.ConteoDetalle) },
    ],
  },
  ...
  { path: 'conteo-detalle', redirectTo: 'conteo-inventario', pathMatch: 'full' },
