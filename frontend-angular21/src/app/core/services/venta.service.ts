...
import { VentasAdminService } from '../../core/services/ventas.service';
...
export class VentaService {
  ...
  getComprobantes(): Observable<VentasAdminService[]> {
    return this.http.get<VentasAdminService[]>(this.apiUrl + '/receipts');
  }
  getComprobanteById(id: number): Observable<VentasAdminService> {
    return this.http.get<VentasAdminService>(`${this.apiUrl}/receipts/${id}`).pipe(
